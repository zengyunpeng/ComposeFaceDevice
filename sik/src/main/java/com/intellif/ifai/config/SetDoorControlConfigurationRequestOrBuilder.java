...
public interface SetDoorControlConfigurationRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:Ifaipb.SetDoorControlConfigurationRequest)
